...
class DeviceCreateView(CreateView):
    model = Device
    fields = ['device_model', 'device_color', 'device_serial', 'device_imei', 'device_vendor', 'device_purchase_date', 'device_purchase_price', 'device_purchase_location', 'device_purchase_department', 'device_purchase_invoice', 'device_purchase_notes', 'device_defects']
...
class WorkOrderCreateView(CreateView):
    model = WorkOrder
    fields = ['workorder_device', 'workorder_vendor', 'workorder_department', 'workorder_location', 'workorder_date', 'workorder_notes']
...
class LaborCreateView(CreateView):
    model = Labor
    fields = ['labor_vendor', 'labor_department', 'labor_location', 'labor_date', 'labor_notes']
...
class ProductCreateView(CreateView):
    model = Product
    fields = ['name', 'description', 'sku', 'category', 'subcategory', 'tags', 'price', 'taxable', 'inventory', 'image']
